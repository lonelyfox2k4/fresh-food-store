                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb mb-1">
                                    <li class="breadcrumb-item"><a
                                            href="${pageContext.request.contextPath}/manager/goods-receipts">Phiếu
                                            nhập</a></li>
                                    <li class="breadcrumb-item active">${empty form.receiptId ? 'Tạo mới' : 'Chỉnh sửa'}
                                    </li>
                                </ol>
                            </nav>
                            <h2 class="fw-800 mb-0">${empty form.receiptId ? 'Tạo phiếu nhập kho' : 'Chỉnh sửa phiếu
                                nhập'}</h2>
                        </div>
                    </div>
                </div>
                ...
                <form method="post" action="${pageContext.request.contextPath}/manager/goods-receipts">
                    ...
                    <div class="user-table-card p-4 mb-4">
                        <div class="row g-4">
                            <div class="col-md-4">
                                ...
                                <input type="text" name="receiptCode" class="form-control" value="${form.receiptCode}"
                                    required>
                            </div>
                            <div class="col-md-4">
                                ...
                                <select name="supplierId" class="form-select" required>
                                    ...
                                    <c:forEach var="s" items="${suppliers}">
                                        <option value="${s.supplierId}" ${form.supplierId==s.supplierId ? 'selected'
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="datetime-local" name="receivedAt" class="form-control"
                                    value="${form.receivedAt}" required>
                            </div>
                            <div class="col-12">
                    ...
                    <div class="user-table-card p-4">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            ...
                            <button type="submit" name="mode" value="add-line"
                                            ...
                                            <td>
                                                ...
                                                <select name="productPackId" class="form-select">
                                                    ...
                                                    <c:forEach var="p" items="${productPacks}">
                                                        <option value="${p.productPackId}"
                                                            ${line.productPackId==p.productPackId ? 'selected' : '' }>
                                                            ${p.displayName}</option>
                                                    </c:forEach>
                                                </select>
                                            </td>
                                            <td><input type="text" name="batchCode" class="form-control"
                                                    value="${line.batchCode}"></td>
                                            <td><input type="date" name="manufactureDate" class="form-control"
                                                    value="${line.manufactureDate}"></td>
                                            <td><input type="date" name="expiryDate" class="form-control"
                                                    value="${line.expiryDate}"></td>
                                            <td><input type="number" name="quantityReceived" min="1"
                                                    class="form-control" value="${line.quantityReceived}"></td>
                                            <td><input type="number" name="unitCost" min="0" step="0.01"
                                                    class="form-control" value="${line.unitCost}"></td>
                                            <td><input type="text" name="lineNote" class="form-control"
                                                    value="${line.note}"></td>
                                        </tr>
                                    </c:forEach>
                                </tbody>
                        ...
                        <div class="d-flex gap-2 justify-content-end mt-4">
                            <a href="${pageContext.request.contextPath}/manager/goods-receipts"
                                class="btn btn-light rounded-pill px-4">Quay lại</a>
