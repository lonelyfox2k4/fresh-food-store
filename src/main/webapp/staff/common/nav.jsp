...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark shadow-sm mb-4">
    <div class="container-fluid px-4">
        <a class="navbar-brand fw-bold text-success" href="${pageContext.request.contextPath}/staff/orders">
            <i class="bi bi-leaf me-1"></i> FRESH FOOD
            <span class="badge bg-success ms-1 small">Staff Area</span>
        </a>
        ...
        <div class="collapse navbar-collapse" id="staffNav">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <a class="nav-link ${requestScope['javax.servlet.forward.servlet_path'].contains('/staff/orders') ? 'active fw-bold text-white' : ''}"
                       href="${pageContext.request.contextPath}/staff/orders">
                        <i class="bi bi-box-seam me-1"></i> Đơn hàng
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link ${requestScope['javax.servlet.forward.servlet_path'].contains('/staff/voucher') ? 'active fw-bold text-white' : ''}"
                       href="${pageContext.request.contextPath}/staff/voucher">
                        <i class="bi bi-ticket-perforated me-1"></i> Voucher
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link ${requestScope['javax.servlet.forward.servlet_path'].contains('/staff/news') ? 'active fw-bold text-white' : ''}"
                       href="${pageContext.request.contextPath}/staff/news">
                        <i class="bi bi-newspaper me-1"></i> Tin tức
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link ${requestScope['javax.servlet.forward.servlet_path'].contains('/staff/feedback') ? 'active fw-bold text-white' : ''}"
