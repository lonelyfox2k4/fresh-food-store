                    ...
                    <div class="auth-card">
                        ...
                        <form action="register" method="post">
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="name" class="form-control border-start-0"
                                        placeholder="Nguyễn Văn A" value="${param.name}" required
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="phone" class="form-control border-start-0"
                                        placeholder="Số điện thoại của bạn" value="${param.phone}" pattern="[0-9]{10}"
                            ...
                            <div class="mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="password" name="password" class="form-control border-start-0"
                                        ...
                                        title="Mật khẩu phải từ 8 ký tự, có ít nhất 1 chữ hoa, 1 chữ thường và 1 chữ số">
                                </div>
                            </div>
                            ...
                            <div class="text-center small">
                                Đã có tài khoản? <a href="login" class="fw-bold text-decoration-none">Đăng nhập</a>
                            </div>
                        </form>
                    </div>
                </div>
